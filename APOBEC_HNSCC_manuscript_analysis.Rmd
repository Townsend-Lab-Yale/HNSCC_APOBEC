...
```{r combining prevalence mutation and heatmaps}
...
save_plot(combined_prev_mut_heat_dendro2,filename = "Figures/prev_mut_heat_dendro.png",base_height =  8,base_width  = 3.25,dpi=600)
```
